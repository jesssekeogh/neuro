...
import { idlFactory } from './neuro-example.did.js';
export { idlFactory } from './neuro-example.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NEURO_EXAMPLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./neuro-example.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the neuro-example canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./neuro-example.did.js")._SERVICE>}
 */
export const neuro_example = createActor(canisterId);
