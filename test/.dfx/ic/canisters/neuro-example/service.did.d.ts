...
export type Result = { 'ok' : Uint8Array | number[] } |
  { 'err' : string };
export type Result_1 = { 'ok' : SnsNeuronId } |
  { 'err' : string };
export type Result_2 = { 'ok' : SnsNeuronInformation } |
  { 'err' : string };
...
export interface Test {
  ...
  >,
  'get_sns_neuron_information' : ActorMethod<[], Result_2>,
  'list_sns_neurons' : ActorMethod<[], Array<SnsNeuronInformation>>,
  'split_sns_neuron' : ActorMethod<[], Result_1>,
